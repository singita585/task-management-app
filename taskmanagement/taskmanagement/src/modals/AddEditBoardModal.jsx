      ...
      >
        ...
        <div className="mt-8 flex flex-col space-y-1">
          ...
          <input className=" bg-transparent  px-4 py-2 rounded-md text-sm  border-[0.5px] border-gray-600 focus:outline-[#635fc7] outline-1  ring-0  "
            placeholder=" e.g Web Design" value={name} onChange={(e) => setName(e.target.value)} id="board-name-input"/>
        </div>
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <div>
            ...
            <button onClick={() => { const isValid = validate(); if (isValid === true) onSubmit(type);}}
